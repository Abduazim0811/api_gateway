...
const (
	...
	OrderService_UpdateOrders_FullMethodName = "/OrderService/UpdateOrders"
)
...
type OrderServiceClient interface {
	...
	GetAllOrders(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderResponse, error)
	UpdateOrders(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *orderServiceClient) CreateOrder(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
...
func (x *orderServiceCreateOrdersClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *orderServiceCreateOrdersClient) Recv() (*Response, error) {
	m := new(Response)
...
func (c *orderServiceClient) GetAllOrders(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *orderServiceClient) UpdateOrders(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
...
type OrderServiceServer interface {
	...
	GetAllOrders(context.Context, *OrderRequest) (*OrderResponse, error)
	UpdateOrders(context.Context, *Request) (*Response, error)
...
func (UnimplementedOrderServiceServer) CreateOrder(context.Context, *Request) (*Response, error) {
...
func (UnimplementedOrderServiceServer) GetAllOrders(context.Context, *OrderRequest) (*OrderResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllOrders not implemented")
}
func (UnimplementedOrderServiceServer) UpdateOrders(context.Context, *Request) (*Response, error) {
...
func _OrderService_CreateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).CreateOrder(ctx, req.(*Request))
	}
...
func (x *orderServiceCreateOrdersServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *orderServiceCreateOrdersServer) Recv() (*Request, error) {
	m := new(Request)
...
func _OrderService_GetAllOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetAllOrders(ctx, req.(*OrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OrderService_UpdateOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).UpdateOrders(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
