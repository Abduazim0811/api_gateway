...
type UserServiceClient interface {
	CreateUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponce, error)
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error)
	GetByIDUser(ctx context.Context, in *UserResponce, opts ...grpc.CallOption) (*User, error)
	GetAllUser(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListUser, error)
}
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponce, error) {
...
func (c *userServiceClient) GetByIDUser(ctx context.Context, in *UserResponce, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
func (c *userServiceClient) GetAllUser(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListUser, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListUser)
...
type UserServiceServer interface {
	CreateUser(context.Context, *UserRequest) (*UserResponce, error)
	Login(context.Context, *LoginRequest) (*LoginResponse, error)
	GetByIDUser(context.Context, *UserResponce) (*User, error)
	GetAllUser(context.Context, *Empty) (*ListUser, error)
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *UserRequest) (*UserResponce, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUser not implemented")
}
func (UnimplementedUserServiceServer) Login(context.Context, *LoginRequest) (*LoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Login not implemented")
}
func (UnimplementedUserServiceServer) GetByIDUser(context.Context, *UserResponce) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByIDUser not implemented")
}
func (UnimplementedUserServiceServer) GetAllUser(context.Context, *Empty) (*ListUser, error) {
...
func _UserService_GetByIDUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetByIDUser(ctx, req.(*UserResponce))
	}
	return interceptor(ctx, in, info, handler)
}
